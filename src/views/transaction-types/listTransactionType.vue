<template>
  <VerticalLayout>
    ...
    <b-row>
      <b-col>
        <UIComponentCard id="basic" title="Daftar Tipe Transaksi">
          <div class="d-flex justify-content-end mb-3">
            <b-button
              variant="primary"
              :to="{ name: 'transaction-type.create' }"
            >
              <i class="bx bx-plus fs-16 me-1"></i>Buat Tipe Transaksi
            </b-button>
          </div>
...
import { useTransactionTypeTable } from "./components/data";
...
const handleGlobalClick = (event: Event) => {
  ...
  if (editBtn) {
    ...
    router.push(`/transaction-type/${editBtn.getAttribute("data-id")}/edit`);
    return;
  }
