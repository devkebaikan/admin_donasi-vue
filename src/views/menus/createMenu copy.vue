          ...
          <b-row class="g-3">
            ...
            <b-col md="6">
              <b-form-group label="Route" label-for="route">
                ...
                />
                <small class="text-muted">Opsional - nama route untuk navigasi</small>
              </b-form-group>
            </b-col>
            ...
            <b-col md="6">
              <b-form-group label="Parent Menu" label-for="parent_id">
                ...
                />
                <small class="text-muted">Opsional - biarkan kosong jika menu utama</small>
              </b-form-group>
            </b-col>
            ...
            <b-col md="6">
              <b-form-group label="Izin Akses" label-for="permissions">
                ...
                />
                <small class="text-muted">Opsional - pilih izin yang diperlukan</small>
              </b-form-group>
            </b-col>
            <b-col md="6">
