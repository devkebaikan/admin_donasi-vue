<template>
  <VerticalLayout>
    <b-row>
      <b-col>
        <UIComponentCard title="Tambah Tag Blog">
          <b-row class="g-3">
            <b-col md="6">
            ...
            <b-col cols="12">
              <div class="d-flex gap-2 justify-content-end">
                ...
                <b-button
                  ...
                  @click="handleSubmit"
                >
                  <b-spinner v-if="isPending" small class="me-1" />Simpan Tag
                </b-button>
              </div>
            </b-col>
          </b-row>
...
import { createBlogTag } from "@/services/blogTagService";
...
const { mutate, isPending } = useMutation({
  mutationFn: () => createBlogTag({ nama: formState.nama.trim() }),
  onSuccess: () => {
    queryClient.invalidateQueries({ queryKey: ["blog-tags"] });
    showToast("Tag blog berhasil ditambahkan", {
      type: "success",
      position: "top-center",
    });
